...
//     fields: {
//         configDef: {type: new GraphQLList(Cy_Node)},
//         configDefExternalRel: {type: new GraphQLList(Cy_Rel)},
//         configDefInternalRel: {type: new GraphQLList(Cy_Rel)},
//         configObj: {type: new GraphQLList(Cy_Node)},
//         configObjExternalRel: {type: new GraphQLList(Cy_Rel)},
//         configObjInternalRel: {type: new GraphQLList(Cy_Rel)},
//         typeData: {type: new GraphQLList(Cy_Node)},
//         typeDataExternalRel: {type: new GraphQLList(Cy_Rel)},
//         typeDataInternalRel: {type: new GraphQLList(Cy_Rel)},
//         instanceData: {type: new GraphQLList(Cy_Node)},
//         instanceDataExternalRel: {type: new GraphQLList(Cy_Rel)},
//         instanceDataInternalRel: {type: new GraphQLList(Cy_Rel)},
